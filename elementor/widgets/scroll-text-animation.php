 ...
 * @since 1.0.0
 */
class Jh_Scroll_Text_Animation_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Text Scroll Animation', 'jhfahim' );
	}
